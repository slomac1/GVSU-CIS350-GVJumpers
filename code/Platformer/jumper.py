...
class Jumper:
    def __init__(self):
        ...
        carnival_controls_surf = pygame.image.load(image_path('player_controls.png')).convert_alpha()
        ...
        tent_controls_surf = pygame.image.load(image_path('player_controls_tent.png')).convert_alpha()
        self.tent_controls_surf = pygame.transform.scale(tent_controls_surf, (250, 133))

        # Control prompt for entering booth and tent
        booth_prompt_surf = pygame.image.load(image_path('enter_minigame_prompt.png')).convert_alpha()
        self.booth_prompt_surf = pygame.transform.scale(booth_prompt_surf, (250, 75))
        tent_prompt_surf = pygame.image.load(image_path('enter_tent_prompt.png')).convert_alpha()
        self.tent_prompt_surf = pygame.transform.scale(tent_prompt_surf, (250, 75))

        # Starting and Ending Message
        starting_message = pygame.image.load(image_path('starting_message.png')).convert_alpha()
        self.starting_message = pygame.transform.scale(starting_message, (450, 200))
        ending_message = pygame.image.load(image_path('ending_message.png')).convert_alpha()
        self.ending_message = pygame.transform.scale(ending_message, (450, 200))

        # Win and Loss images
        win_message = pygame.image.load(image_path('won.png')).convert_alpha()
        self.win_message = pygame.transform.scale(win_message, (900,600))
        lost_message = pygame.image.load(image_path('lost.png')).convert_alpha()
        ...
        '''
        self.tent_background = pygame.image.load(image_path('tent_background.png')).convert_alpha()
    ...
    def create_tent_area(self):
        ...
        stands_right = pygame.image.load(image_path('stands.png')).convert_alpha()
